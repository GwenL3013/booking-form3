            ...
            <Card border={border} className="todo_card" style={{ backgroundColor: cardBackgroundColor }}>
                ...
                <Card.Body>
                    ...
                    <div className="todo-buttons">
                        <Button onClick={startTimer} className="todo-btn">
                            <i className="bi bi-play"></i>
                        </Button>
                        <Button onClick={pauseTimer} className="todo-btn">
                            <i className="bi bi-pause-fill"></i>
                        </Button>
                        <Button onClick={resetTimer} className="todo-btn">
                            <i className="bi bi-arrow-clockwise"></i>
                        </Button>
                        <Button variant="secondary" onClick={onEdit} className="todo-btn">
                            <i className="bi bi-pencil"></i>
                        </Button>
                        <Button variant="danger" onClick={deleteTodo} className="todo-btn">
